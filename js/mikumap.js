...
var DICTIONARY = {};
var user_id;
var roomID = decodeURI(location.hash.replace(location.hash.substr(0,1),''));
...
function registerAsMember(){
    var ds_mem = milkcocoa.dataStore('members');
    if (user_id) ds_mem.push({ "userID" : user_id, "date" : new Date(), "roomID" : roomID });
}
